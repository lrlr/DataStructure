...
public class MergeSort {
    public static int[] merSortOne(int[] arr,int left,int right){
        if (left<right){
            int mid=(left+right)/2;
            merSortOne(arr,left,mid);
            merSortOne(arr,mid+1,right);
    ...
    private static void mergeOne(int[] arr,int left,int mid,int right){
